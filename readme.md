I'm looking to build a JavaScript/TypeScript SDK that helps developers create AI agents that learn from conversations with users. Here's what it needs to do:
